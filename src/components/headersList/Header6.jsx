...
const Header6 = () => {
    return (
        <div className="flex justify-center items-center px-4 mt-17 sm:mt-4 sm:px-8 md:px-12 md:mt-5 lg:mt-2 lg:px-20 lg:h-full">
            <div
                className="
                ...
                sm:p-4 lg:p-2 sm:h-[520px] lg:w-full lg:min-h-[500px] 
                xl:h-[580px]
            "
            >
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-1 sm:mb-2 md:pt-2 text-blue-600">
                ...
                <div className="flex justify-center z-100">
                    <p className="text-center text-gray-500 mt-1 w-[90%] sm:mt-4 text-xs sm:text-sm md:mt-0 md:pt-5 lg:text-lg lg:pt-2">
